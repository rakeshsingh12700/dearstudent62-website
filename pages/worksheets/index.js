...
export default function Worksheets() {
  ...
  return (
    <>
      <Navbar />
      <WorksheetShop
        key={`${classFromQuery}-${typeFromQuery}-${subjectFromQuery}-${topicFromQuery}-${subtopicFromQuery}-${sortFromQuery}-${searchFromQuery}-${mobileViewFromQuery}-${openCartFromQuery ? "cart" : "list"}`}
