...
export default function ClassPage() {
  ...
  return (
    <>
      <Navbar />
      <WorksheetShop
        key={`${classFromRoute}-${typeFromQuery}-${subjectFromQuery}-${topicFromQuery}-${subtopicFromQuery}-${sortFromQuery}-${searchFromQuery}-${mobileViewFromQuery}-${openCartFromQuery ? "cart" : "list"}`}
