    ...
    const nextCart = existingItem
      ...
      : [
          ...existingCart,
          {
            ...
            displayPrice: getPriceAmount(product),
            displayCurrency: getPriceCurrency(product),
            displaySymbol: String(product.displaySymbol || "").trim(),
            basePriceINR: Number(product.basePriceINR || staticProduct?.price || product.price || 0),
            class: product.class,
